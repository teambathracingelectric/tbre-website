...
Responsible for design and integration of steering and braking systems for autonomous control. You will not only work closely with the software Al team to enable accurate control, but with Electrical, Vehicle Dynamics, and Mechanical Design teams as well. The role is critical to the full integration of the autonomous driving system into the main car.
Responsibilities:
