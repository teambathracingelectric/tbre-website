...
'Working with TBReAl to improve and maintain the autonomous driving system, using C/C++ to gain experience in autonomous vehicle technologies and methods. This is a hands-on opportunity to develop a real-world system which will compete across the UK and Europe.
