    ...
    <div className="min-h-screen bg-white">
        ...
        <Card className="overflow-hidden border-zinc-200">
          <CardContent className="grid gap-8 p-0 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-6 md:p-8">
              <div className="mb-4 inline-block w-fit rounded-full bg-tbre-blue/10 px-3 py-1 font-medium text-sm text-tbre-blue">
                {featuredBlog.category}
              </div>
              <h2 className="mb-4 font-bold text-2xl text-zinc-900 sm:text-3xl">
                {featuredBlog.title}
              </h2>
      ...
      <section className="border-t bg-zinc-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="mb-8 font-bold text-2xl text-zinc-900">All Posts</h2>
            ...
            {blogs.map((post) => (
              ...
              >
                <CardContent className="p-0">
                  ...
                  <div className="p-6">
                    <div className="mb-3 inline-block rounded-full bg-tbre-blue/10 px-3 py-1 font-medium text-sm text-tbre-blue">
                      {post.category}
                    </div>
                    <h3 className="mb-3 font-bold text-xl text-zinc-900">
                      {post.title}
                    </h3>
