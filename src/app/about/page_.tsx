...
export const metadata: Metadata = {
  title: "About",
  description: "Learn more about Team Bath Racing Electric.",
};
  ...
  return (
    <main className="pt-8 min-h-screen flex flex-col items-center">
      ...
      <p className="md:w-2/3 p-4">
        ...
        race a formula-style car for the Formula Student competition against
        ...
        the first UK electric team to compete abroad, competing in Zhuhai, China
        in 2018.
        <br />
        <br />
        In 2022 we competed in Italy and Spain which helped maintain our spot as
        #1 UK Electric Formula Student Team.
        <br />
        <br />
        Unlike many competitors, TBRe utilises a fully electric powertrain with
        an Emrax 228 motor rear-wheel drive and a custom in-house designed and
        built battery pack.
        <br />
        <br />
